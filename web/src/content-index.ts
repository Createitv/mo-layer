...
import { generatedContentIndex } from './generated-articles';
...
export const contentIndex: ContentIndexEntry[] = [
  ...
  },
  {
    ...
    title: 'Mo Layer Terms of Service',
    description: 'The service terms for using Mo Layer, including private content rules, subscriptions, iCloud sync, acceptable use, and contact information.'
  },
  {
    locale: 'en-US',
    slug: 'privacy-policy',
    translationKey: 'privacy-policy',
    title: 'Mo Layer Privacy Policy',
    description: 'How Mo Layer handles private vault content, optional iCloud sync, app permissions, feedback data, subscriptions, and privacy choices.'
  },
  {
    locale: 'de-DE',
    slug: 'privacy-first-file-vault',
  ...
  },
  {
    ...
    translationKey: 'privacy-policy',
    title: '墨层隐私政策',
    description: '说明墨层如何处理私密保险箱内容、可选 iCloud 密文同步、App 权限、官网反馈数据、订阅信息和用户选择。'
  },
  {
    locale: 'zh-Hant',
    slug: 'privacy-first-file-vault',
